...
describe('GET Stock list route', () => {    
    const expectedStockList = [ { _id: '5c54568a6855e61af094a49e',
    ticker: 'AAPL',
...
// 1. is the difference between resnet 34 and 50 the amount of validation sets that are used in training
// 2. when they say layers is that comparable to back propogation in deep learning where there are loss functions and input output layers
